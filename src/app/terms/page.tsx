...
export const metadata: Metadata = {
  ...
  description: 'Read the Terms of Use governing your access to and use of the NxtSft.com platform and services.',
};
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border bg-white">
        <div className="mx-auto max-w-4xl px-6 py-16">
          ...
          <h1 className="mt-3 font-display text-4xl font-black text-navy sm:text-5xl">Terms of Use</h1>
        ...
        <div className="grid gap-8 lg:grid-cols-[220px_1fr]">
          ...
          <article className="space-y-10">
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-6 py-4 text-sm text-amber-800">
              <strong>Important notice:</strong> NxtSft.com is an online marketplace intermediary. We do not own, sell, or lease any property and are not party to any real estate transaction. All transactions are solely between the buyer/tenant and seller/landlord.
            </div>
                ...
                {'contact' in s && s.contact && (
                  <div className="mt-4 rounded-xl border border-border bg-white p-5 text-sm">
                    ...
                    <div className="mt-3 space-y-1">
                      <div>General: <a href={`mailto:${s.contact.email}`} className="text-accent hover:underline">{s.contact.email}</a></div>
                      <div>Support: <a href={`mailto:${s.contact.support}`} className="text-accent hover:underline">{s.contact.support}</a></div>
                    </div>
                  </div>
                )}
              </section>
