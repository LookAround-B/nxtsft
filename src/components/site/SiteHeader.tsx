...
import { Menu, X, ChevronDown, Plus, Minus, Building2, Home, MapPin, Briefcase, Users, TrendingUp } from 'lucide-react';
                    ...
                    <div className="invisible absolute left-1/2 top-full z-50 mt-1.5 w-[480px] -translate-x-1/2 scale-95 rounded-2xl border border-border bg-white opacity-0 shadow-2xl shadow-navy/10 transition-all duration-200 group-hover:visible group-hover:scale-100 group-hover:opacity-100">
                      <div className="grid grid-cols-2">
                        ...
                        <div className="p-5 border-r border-border/60">
                          <div className="mb-3 text-[10px] font-bold uppercase tracking-widest text-accent">By Property Type</div>
                        ...
                        {/* By City */}
                        <div className="p-5">
                          <div className="mb-3 text-[10px] font-bold uppercase tracking-widest text-accent">By City</div>
                          <ul className="space-y-0.5">
                    ...
                    <div key={l.to}>
                      ...
                      {isExpanded && (
                        <div className="ml-4 mt-1 mb-2 space-y-3 rounded-xl border border-border/60 bg-secondary/40 p-3">
                          {/* By Type */}
                          <div>
                            <div className="px-2 py-1 text-[10px] font-bold uppercase tracking-widest text-accent">By Type</div>
                          ...
                          <div className="border-t border-border/60 pt-2">
                            <div className="px-2 py-1 text-[10px] font-bold uppercase tracking-widest text-accent">By City</div>
