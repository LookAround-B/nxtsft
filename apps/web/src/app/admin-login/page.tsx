                ...
                {ROLES.map((r, i) => {
                  ...
                  return (
                    ...
                    >
                      {/* Active indicator */}
                      {isActive && (
                        <span className="absolute right-3 top-3 flex h-5 w-5 items-center justify-center rounded-full bg-accent text-white text-[10px] font-black">
                          ✓
                        </span>
                      )}
                      ...
                      {/* Icon */}
                      <div
                        className={`flex h-11 w-11 items-center justify-center rounded-xl bg-gradient-to-br text-white ${r.accent}`}
                      >
                        {r.icon}
                      </div>
                      ...
                      <div className="min-w-0">
                        ...
                        <div className={`mt-0.5 text-[11px] font-semibold ${r.textAccent}`}>
                          {meta.portalName}
                        </div>
