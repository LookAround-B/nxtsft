  ...
  return (
    ...
    >
      <div className="font-display text-3xl font-black text-accent sm:text-4xl">
        {prefix}
        {active ? (Number.isInteger(num) ? count : count.toFixed(0)) : 0}
        {suffix}
      </div>
...
const VALUES = [
  {
    ...
    desc: "Every listing is RERA-verified. No hidden fees, no grey-market deals.",
  },
  {
    Icon: Users,
    title: "People-Centric",
    desc: "Dedicated relationship managers ensure no buyer or seller is left without support.",
  },
  {
    Icon: BarChart2,
    title: "Data-Driven",
    desc: "Price analytics, locality trends and demand signals — all in real time.",
  },
  {
    Icon: Zap,
    title: "Technology-Led",
    desc: "AI matching, smart alerts and automated CRM workflows built for modern India.",
  },
];
    ...
    <>
      ...
      <section className="relative overflow-hidden border-b border-border bg-navy text-white">
        <div className="pointer-events-none absolute inset-0" aria-hidden>
          {/* blobs */}
          <div
            className="absolute -right-20 -top-10 h-80 w-80 animate-blob rounded-full opacity-20 blur-3xl"
            style={{ background: "oklch(0.72 0.12 186)" }}
          />
          <div
            className="absolute -left-10 top-1/2 h-60 w-60 animate-blob-slow rounded-full opacity-15 blur-3xl"
        ...
        <div className="relative mx-auto max-w-4xl px-6 py-20 sm:py-24">
          ...
          >
            Real estate, <span className="text-gradient-hero">re-engineered</span> for India.
          </h1>
          <p
            data-reveal
          ...
          >
            ...
            <div className="relative">
              ...
              <p className="mx-auto mt-3 max-w-sm text-sm text-white/70">
                Whether you&apos;re buying, renting or selling — we&apos;re here to make it
                seamless.
              </p>
