        ...
        <div className="mt-12 grid gap-10 md:grid-cols-2">
          <form className="space-y-4 rounded-2xl border border-border bg-white p-8">
            ...
            <div>
              ...
              <textarea
                rows={4}
                className="mt-1 w-full rounded-lg border border-border bg-secondary/40 px-4 py-3 text-sm outline-none focus:border-accent"
              />
            </div>
            <button
              type="button"
              onClick={() => toast.success("Enquiry sent! We'll reach out within 24 hours.")}
              className="w-full rounded-xl bg-accent py-3 font-display text-sm font-bold text-accent-foreground transition hover:-translate-y-0.5 hover:opacity-90 hover:shadow-lg hover:shadow-accent/20"
            >
              Send Enquiry →
            </button>
          </form>
