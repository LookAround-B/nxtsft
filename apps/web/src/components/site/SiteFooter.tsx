    ...
    <footer className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 pt-14 pb-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10">
          {/* Discover */}
          <div>
            <h3 className={HL} style={{ color: "var(--gold)" }}>
              Discover
            </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-white/70">
              NxtSft.com is India&apos;s next-generation real estate ecosystem — connecting buyers,
              sellers, builders and agents through a single intelligent platform. With RERA-verified
              listings, AI-powered matching, zero brokerage and an integrated CRM+ERP suite, we make
              every property transaction transparent, efficient and trustworthy.
            </p>
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 py-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <div>
            <h3 className={HL} style={{ color: "var(--gold)" }}>
              Experience NxtSft.com App on Mobile
            </h3>
            <p className="text-sm text-white/60 mb-5">
              Search, shortlist, buy and sell — all from your phone.
            </p>
            <div className="flex gap-3 flex-wrap">
              {/* Google Play */}
              <a
                href="#"
                className="flex items-center gap-2.5 px-4 py-2.5 rounded-xl border border-white/20 bg-white/5 transition hover:border-gold"
              >
          ...
          <div>
            ...
            <p className="text-sm text-white/60 mb-5">
              Follow us for property deals, market insights and real estate news.
            </p>
          ...
          <div className="flex flex-col items-center gap-3 sm:flex-row sm:justify-between">
            ...
            <div className="flex flex-wrap items-center justify-center gap-3 sm:justify-end">
              ...
              <span className="text-xs italic text-white/30">
                Apna Ghar, Apni Pehchaan. &mdash; India
              </span>
              <Link
                href="/admin-login"
