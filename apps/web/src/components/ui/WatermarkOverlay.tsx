 ...
 *
 * Uploaded photos are watermarked at upload (compressImage) and live on our R2
 * CDN, so they need no overlay — rendering one anyway double-stamps them (a
 * visible "ghost"/shadow). Seeded/demo listings use external stock URLs
