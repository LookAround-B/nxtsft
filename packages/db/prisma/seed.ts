...
async function main() {
  ...
  const leadSeed = [
    { id: "seed-lead-01", slug: "skyline-3bhk-bandra-west-mumbai", name: "Vikram Desai", phone: "9820011001", city: "Mumbai", interest: "3 BHK Apartment", source: "Portal", status: "Hot", value: 65000000, buyer: rohan, notes: "[2026-06-08 10:42] Priya Sharma: Site visit booked Sat 11am — wants sea-facing, ready to close if price holds." },
    { id: "seed-lead-02", slug: "green-acres-villa-whitefield-bengaluru", name: "Sneha Reddy", phone: "9845022002", city: "Bengaluru", interest: "4 BHK Villa", source: "WhatsApp", status: "Warm", value: 42000000, buyer: ananya, notes: "[2026-06-08 09:15] Priya Sharma: Sent floor plan on WhatsApp, awaiting feedback on Whitefield villa." },
    { id: "seed-lead-03", slug: "urban-nest-2bhk-koregaon-park-pune", name: "Arjun Mehta", phone: "9011033003", city: "Pune", interest: "2 BHK Rental", source: "Referral", status: "Hot", value: 660000, buyer: rohan, notes: "[2026-06-09 14:20] Priya Sharma: Negotiating rent — landlord open to ₹2k/mo off if 24-month lease." },
    { id: "seed-lead-04", slug: "corporate-suite-office-cyber-city-gurgaon", name: "Priyanka Joshi", phone: "9711044004", city: "Gurgaon", interest: "Office space", source: "Direct", status: "New", value: 2220000, buyer: ananya, notes: "[2026-06-09 16:05] Priya Sharma: Fresh enquiry, not yet contacted — needs seating for 12." },
    { id: "seed-lead-05", slug: "metro-heights-2bhk-noida-sector-62", name: "Rohit Khanna", phone: "9911055005", city: "Noida", interest: "2 BHK Apartment", source: "Portal", status: "Cold", value: 8800000, buyer: rohan, notes: "[2026-06-03 16:05] Priya Sharma: Called twice, no answer. Cold — retry next week." },
    { id: "seed-lead-06", slug: "palm-grove-3bhk-gachibowli-hyderabad", name: "Meghana Rao", phone: "9849066006", city: "Hyderabad", interest: "3 BHK Apartment", source: "WhatsApp", status: "Warm", value: 14500000, buyer: ananya, notes: "[2026-06-07 11:30] Priya Sharma: Comparing Gachibowli vs Kondapur — will decide after weekend visit." },
    { id: "seed-lead-07", slug: "lakeview-studio-hitech-city-hyderabad", name: "Karthik Nair", phone: "9000077007", city: "Hyderabad", interest: "Studio rental", source: "Portal", status: "New", value: 336000, buyer: rohan, notes: "[2026-06-10 08:50] Priya Sharma: Wants immediate move-in, asked for furnished options near HITEC." },
    { id: "seed-lead-08", slug: "heritage-bungalow-alkapuri-vadodara", name: "Deepika Shah", phone: "9925088008", city: "Ahmedabad", interest: "5 BHK Bungalow", source: "Referral", status: "Hot", value: 38000000, buyer: ananya, notes: "[2026-06-10 12:15] Priya Sharma: Very keen, negotiating on parking and registration costs." },
    { id: "seed-lead-09", slug: "worli-penthouse-mumbai", name: "Karan Joshi", phone: "9876012345", city: "Mumbai", interest: "4 BHK Penthouse", source: "Portal", status: "Warm", value: 95000000, buyer: ananya, notes: "[2026-06-12 13:30] Priya Sharma: Loved the sea view, asked about floor-rise premium." },
  ];
